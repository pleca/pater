<?php
	require_once(MCMANAGER_ABSPATH . "../../../../../../application/config/config.php"); //laduje ustawienia z glownego configa
	require_once(MCMANAGER_ABSPATH . "../../../../../../application/config/config_common.php"); //laduje ustawienia z wspolnego configa
	$myRoot = CMS_DIR;
	$myHost = SERVER_URL.CMS_URL;
   ...
   // * * * * ImageManager config
	...
	// Preview options
	$mcImageManagerConfig['preview.wwwroot'] = $myRoot.'/files'; // absolute or relative from this script path, try to leave blank system figures it out.
	$mcImageManagerConfig['preview.urlprefix'] = $myHost.'/files'; // domain name
	...
	$mcImageManagerConfig['filesystem.path'] = $myRoot.'/files';  // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = $myRoot.'/files';  // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,wmv,asf,flv,doc,pdf";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,doc,pdf,flv,avi,wmv";
