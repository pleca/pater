...
check_permission('phrase'); // sprawdzamy dostep dla podanego modulu
...
class PhraseController {
	...
	function listAction($params = []) {       
        ...
        $uzycia = $this->entity->loadUzycia();
		
		$data = array(
			'entities'	=> $entities,
			'uzycia'	=>	$uzycia,
			'pageTitle' => $GLOBALS['LANG']['module_phrase']
		);

		echo Cms::$twig->render('admin/phrase/list.twig', array_merge($data, $params));		
	}
