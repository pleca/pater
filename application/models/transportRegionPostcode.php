...
class TransportRegionPostcodeModel extends BaseModel {

	private $table;

	public function __construct() {
		$this->table = DB_PREFIX . 'transport_region_postcode';
	}
	...
	public function getByRegionIdPost1($region_id = 0, $post1 = '') {
