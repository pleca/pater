...
class TransportRegionServiceModel extends BaseModel {

	private $table;

	public function __construct() {
		$this->table = DB_PREFIX . 'transport_region_service';
	}
	...
	public function getByRegionIdServiceId($region_id = 0, $service_id = 0) {
