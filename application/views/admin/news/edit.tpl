    ...
    <form id="form" method="post" action="{$smarty.server.PHP_SELF}" enctype="multipart/form-data">
        ...
        <table class="tableEdit" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td class="right">
                    {if $aItem.photo}<a href="{$aItem.photo.normal}" title="{$aItem.title}" class="fancybox">
                            <img src="{$aItem.photo.small}" alt="{$aItem.title}" /></a><br />
                        <a href="?action=photo_delete&amp;id={$aItem.id}" onclick="return confirmDelete();" title="{$aLang.delete_server}">{$aLang.delete_server}</a>{/if}
                    </td>
                </tr>
                {if $gallery}
                    <tr>
                ...
                <tr>
                    ...
                    <td class="center">
                        ...
                        <input type="image" src="{$PATH_URL}/btnSavePublish.png" onclick="setAction('savePublish');" />
                        <input type="image" src="{$PATH_URL}/btnSaveContinue.png" onclick="setAction('saveContinue');" />
