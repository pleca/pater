	...
	function process($server_path = null) {
		...
		if ($this->processed) {
			...
			if ($this->file_safe_name) { // formats the name
				$this->file_dst_name_body = utf8_encode(strtr(utf8_decode($this->file_dst_name_body), utf8_decode('Ĺ Ĺ˝ĹĄĹžĹ¸ĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂĂ ĂĄĂ˘ĂŁĂ¤ĂĽĂ§Ă¨ĂŠĂŞĂŤĂŹĂ­ĂŽĂŻĂąĂ˛ĂłĂ´ĂľĂśĂ¸ĂšĂşĂťĂźĂ˝Ăż'), 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'));
				$this->file_dst_name_body = strtr($this->file_dst_name_body, array('Ă' => 'TH', 'Ăž' => 'th', 'Ă' => 'DH', 'Ă°' => 'dh', 'Ă' => 'ss', 'Ĺ' => 'OE', 'Ĺ' => 'oe', 'Ă' => 'AE', 'ĂŚ' => 'ae', 'Âľ' => 'u'));
